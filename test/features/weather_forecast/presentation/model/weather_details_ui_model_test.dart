...
void main() {
  test('WeatherDetailsUiModel fromWeatherDetailsEntity maps correctly', () {
    ...
    final dateFullName = DateFormat("EEEE").format(DateTime.fromMillisecondsSinceEpoch(timestamp * 1000));
    final dateShortName = DateFormat("EEE").format(DateTime.fromMillisecondsSinceEpoch(timestamp * 1000));
    ...
    final uiModel = WeatherDetailsUiModel.fromWeatherDetailsEntity(weatherDetailsEntity);
